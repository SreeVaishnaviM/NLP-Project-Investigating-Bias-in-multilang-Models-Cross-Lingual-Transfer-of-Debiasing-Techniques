...
#Getting the director from user 

thisdir = os.path.dirname(os.path.realpath(__file__))

#Getting the parameters of folder from user
...
#Getting modelparameter from user 
parser.add_argument(
    "--model",
    action="store",
    type=str,
...
#Getting language debias from user 
parser.add_argument(
    "--lang_debias",
    action="store",
    type=str,
