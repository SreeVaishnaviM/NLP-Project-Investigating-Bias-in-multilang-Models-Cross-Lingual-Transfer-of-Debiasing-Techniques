...
class _SentenceDebiasDataset:
    ...
    def __init__(self, persistent_dir, bias_type,lang_debias):
        ...
        if self._lang_debias=='en':
            with open(f"{self._persistent_dir}/data/bias_attribute_words.json", "r", encoding="utf8") as f:
                self._attribute_words = json.load(f)[self._bias_type]
        elif self._lang_debias =='fr':
            with open(f"{self._persistent_dir}/data/bias_attribute_words_fr.json", "r", encoding="utf8") as f:
                self._attribute_words = json.load(f)[self._bias_type]
        elif self._lang_debias =='de':
            with open(f"{self._persistent_dir}/data/bias_attribute_words_de.json", "r", encoding="utf8") as f:
                self._attribute_words = json.load(f)[self._bias_type]
                print(self._attribute_words)
        elif self._lang_debias =='nl':
            with open(f"{self._persistent_dir}/data/bias_attribute_words_nl.json", "r", encoding="utf8") as f:
                self._attribute_words = json.load(f)[self._bias_type]
        elif self._lang_debias =='pl':
            with open(f"{self._persistent_dir}/data/bias_attribute_words_pl.json", "r", encoding="utf8") as f:
                self._attribute_words = json.load(f)[self._bias_type]
                print(self._attribute_words)
        elif self._lang_debias =='ru':
            with open(f"{self._persistent_dir}/data/bias_attribute_words_ru.json", "r", encoding="utf8") as f:
                self._attribute_words = json.load(f)[self._bias_type]
