...
def _load_gender_data(persistent_dir,lang_debias):
    ...
    if lang_debias=='en':
        with open(f"{persistent_dir}/data/bias_attribute_words.json", "r", encoding="utf8") as f:
...
def _load_race_data(persistent_dir,lang_debias):
    ...
    if lang_debias=='en':
        ...
        with open(f"{persistent_dir}/data/text/wikipedia-2.5.txt", "r", encoding="utf8") as f:
            lines = f.readlines()
        random.shuffle(lines)
